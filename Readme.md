...
the Shiny app listed above. This app starts automatically once you run the container.
...
The Shiny app will also get started, and you can visit it over at `http://localhost:1506/`.
Upload the `.rds` file that is in the `output/` folder and view the results.
